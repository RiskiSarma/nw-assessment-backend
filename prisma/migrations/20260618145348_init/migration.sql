-- CreateEnum
CREATE TYPE "Role" AS ENUM ('PM', 'INTERNAL', 'CLIENT_GUEST');
...
-- AddForeignKey
ALTER TABLE "task_dependencies" ADD CONSTRAINT "task_dependencies_dependentId_fkey" FOREIGN KEY ("dependentId") REFERENCES "tasks"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "task_dependencies" ADD CONSTRAINT "task_dependencies_prerequisiteId_fkey" FOREIGN KEY ("prerequisiteId") REFERENCES "tasks"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
